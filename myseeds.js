...
module.exports = function(callback) {
 ...
 EcommerceStore.deployed().then(function(i) {i.addProductToStore('天梭男', '手表', 'QmU5EKkgNqredTV1sfE5tq1QGxxn3dV7KyQK7Ld3Li919X', 'QmQX7QeDspxdoSNf3Ntkio6oQfDQJ68tmHY4kBPjLKhpPH', current_time, current_time + 200, 2*amt_1, 0).then(function(f) {console.log(f)})});
